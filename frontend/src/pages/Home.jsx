      ...
      <header className="fixed top-0 left-0 right-0 z-50 w-full px-6 py-6 bg-background-dark/80 backdrop-blur-xl text-white border-b border-border-subtle">
        <div className="max-w-[1440px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link
              to="/signup"
              className="px-5 py-2 bg-primary text-background-dark text-sm font-bold rounded-full hover:bg-white transition-colors duration-300"
            >
              Join Now
            </Link>
          </div>
      ...
      <main className="flex-grow pt-32 pb-24 px-6">
        <section className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-4 auto-rows-[minmax(180px,auto)] grid-dense mb-24">
          <div className="md:col-span-8 md:row-span-2 rounded-3xl bg-surface p-10 md:p-16 flex flex-col justify-between border border-border-subtle relative overflow-hidden group">
            ...
            <div className="relative z-10 max-w-lg mt-auto">
              <p className="text-lg text-text-secondary mb-8 leading-relaxed">
                A minimalistic planner for the dedicated athlete. Strip away the
                noise and focus on raw progression.
              </p>
              <div className="flex items-center gap-4">
                <Link
                  to="/signup"
                  className="h-12 px-8 bg-white text-black rounded-full font-bold hover:bg-primary transition-colors duration-300 flex items-center justify-center"
                >
                  Start Trial
                </Link>
          ...
          <div className="md:col-span-5 md:row-span-1 rounded-3xl bg-primary p-8 flex flex-col justify-center text-background-dark relative overflow-hidden group">
            <div className="relative z-10">
              <h3 className="font-bold text-3xl mb-2 font-display">
                Data Driven
              </h3>
              <p className="font-medium opacity-80">
                Visualize your volume, intensity, and 1RM estimates instantly.
              </p>
            </div>
        ...
        <section className="max-w-[1440px] mx-auto mb-32" id="features">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 px-2">
            ...
            <p className="text-text-secondary text-right mt-4 md:mt-0 max-w-xs text-sm">
              Tools that adapt to your specific training methodology, not the
              other way around.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-auto">
            <div className="md:col-span-1 md:row-span-2 bg-surface rounded-3xl p-8 border border-border-subtle flex flex-col relative overflow-hidden group">
              ...
              <div className="mt-auto relative z-10">
                ...
                <p className="text-text-secondary leading-relaxed mb-8">
                  Life is unpredictable. Drag, drop, and adjust your training
                  days on the fly without breaking your streaks.
                </p>
            ...
            <div className="md:col-span-2 bg-surface rounded-3xl p-8 md:p-12 border border-border-subtle flex flex-col md:flex-row items-center gap-8 group">
              <div className="flex-1">
                ...
                <p className="text-text-secondary">
                  Input sets, reps, and RPE with zero friction. The interface
                  remembers your history and auto-suggests weights.
                </p>
              </div>
              <div className="w-full md:w-1/2 bg-black/40 rounded-2xl p-6 border border-white/5 shadow-2xl transform md:rotate-2 group-hover:rotate-0 transition-transform duration-500">
                ...
                <div className="flex gap-2">
                  <div className="h-10 w-12 bg-surface-highlight rounded flex items-center justify-center text-white text-sm">
                    8
                  </div>
                  <div className="h-10 flex-grow bg-primary text-black rounded font-bold flex items-center justify-center text-sm cursor-pointer hover:bg-white transition-colors">
                    Log Set
                  </div>
                </div>
              </div>
            ...
            <div className="bg-surface rounded-3xl p-8 border border-border-subtle hover:border-primary/30 transition-colors">
              ...
              <p className="text-text-secondary text-sm">
                Start with 5/3/1, PPL, or build your own routine in seconds.
              </p>
            </div>
            ...
            <div className="bg-surface rounded-3xl border border-border-subtle overflow-hidden relative group h-64 md:h-auto">
              ...
              <div className="absolute inset-0 bg-black/60 p-8 flex flex-col justify-end items-start">
                ...
                <span className="material-symbols-outlined text-primary mt-4 group-hover:translate-x-2 transition-transform">
                  arrow_forward
                </span>
              </div>
            </div>
        ...
        <section className="max-w-[1440px] mx-auto mb-32" id="testimonials">
          <div className="mb-16 text-center md:text-left px-2">
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold text-white relative z-10 pt-4">
          ...
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
            <div className="break-inside-avoid bg-surface border border-border-subtle p-8 rounded-3xl">
              ...
              <blockquote className="text-lg text-white font-medium mb-6">
                "Finally, an app that isn't trying to be a social network. It's
                just me, the weights, and the data."
              </blockquote>
              <div className="flex items-center gap-3">
                <div
            ...
            <div className="break-inside-avoid bg-primary text-background-dark p-8 rounded-3xl">
              ...
              <blockquote className="text-xl font-bold leading-tight mb-6">
                "I broke through a 3-month plateau on my squat thanks to the
            ...
            <div className="break-inside-avoid bg-surface border border-border-subtle p-8 rounded-3xl">
              <blockquote className="text-white mb-6">
                "The ability to copy previous weeks saves me so much planning
                time. It's streamlined my Sunday routine perfectly."
              </blockquote>
              <div className="flex items-center gap-3">
                <div
                  className="w-10 h-10 rounded-full bg-cover bg-center"
        ...
        <section
          className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4"
          id="how-it-works"
        >
          <div className="bg-surface rounded-3xl p-12 lg:p-24 flex flex-col justify-center border border-border-subtle relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-text-secondary max-w-md mb-10">
                Start your 14-day free trial today. Experience the difference of
                a distraction-free environment.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/signup"
                  className="px-8 py-4 bg-white text-black text-lg font-bold rounded-full hover:bg-primary transition-colors duration-300 flex items-center justify-center"
                >
                  Get Started Free
                </Link>
          ...
          <div className="bg-primary rounded-3xl min-h-[400px] lg:min-h-auto relative overflow-hidden group">
            <div
              className="absolute inset-0 bg-cover bg-center mix-blend-multiply opacity-50 grayscale group-hover:grayscale-0 transition-all duration-700"
              style={{ backgroundImage: 'url("/imgs/img4.jpg")' }}
            ></div>
            <div className="absolute inset-0 bg-gradient-to-t from-primary/90 to-transparent"></div>
            <div className="absolute bottom-12 left-12 right-12">
              <span className="material-symbols-outlined text-6xl text-background-dark mb-4 block">
                fitness_center
              </span>
              <p className="text-background-dark text-2xl font-display font-bold max-w-sm">
        ...
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
            <div className="md:col-span-4">
              ...
              <p className="text-text-secondary text-sm leading-relaxed mb-6 max-w-xs">
                The modern standard for workout tracking. Built for those who
          ...
          <div className="pt-8 border-t border-border-subtle flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-text-secondary text-xs">
              © 2024 RepStack Inc. All rights reserved.
            </p>
